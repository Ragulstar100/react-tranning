...
export function ProjectTextField1({value,onChange,label,placeholder,inlineValidation,inlineRestrtiction,blockCutCopy,blockPaste,type='text',trailingIcon,leadingIcon}){
  return (
    <TextField
      value={value}
      onChange={onChange}
